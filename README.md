...
Cross-platform SFTP / SCP / FTP client inspired by WinSCP with modern UI, built using Electron.
...
- 🔄 Auto-upload on save editor workflow
...
**Remove user data** (optional — deletes saved sessions and settings):
```bash
